...
public class WorkOrder {
    ...
    private List<WorkOrderNote> notesList = new ArrayList<>();
    ...
    public void updateStatusBasedOnItems() {
        ...
        // Rule: Preserve CUSTOMER_SUBMITTED until staff confirms intake review
        // (Don't auto-advance to RECEIVED until staff explicitly activates the order)
        if (WorkOrderStatus.CUSTOMER_SUBMITTED.name().equals(this.status)) {
            return; // Keep CUSTOMER_SUBMITTED until intake review is confirmed
        }
    ...
    public Boolean getCustomerCreated() {
    ...
    public List<WorkOrderNote> getNotesList() {
        return notesList;
    }

    public void setNotesList(List<WorkOrderNote> notesList) {
